...
const getStartingPrice = (req, res) => {
    var body = req.body || {};
    var inputToSF = {
    ...
    axios(authSF).then(function (auth) {
        var callSF = {
            method: "get",
            url: "https://prometheusreg--training.sandbox.my.salesforce.com/services/apexrest/v1/getNeighborhoods",
            headers: {
        ...
        axios(callSF)
            ...
            if (response.data.length > 0) {
                for (var i = 0; i < response.data.length; i++) {
                    ...
                    getFloorPlans_adapter_1.GetFloorPlansAdapter.getFloorPlans(inputToWebPricing).then((output) => {
...
//# sourceMappingURL=getStartingPrice-controller.js.map