...
const getUnitsByProperty = (req, res) => {
    var body = req.body || {};
    var args = {
        "tem:auth": {
    ...
    RPXclient(function (client) {
        console.log('Calling unitlist with args ' + JSON.stringify(args));
        client.getunitsbyproperty(args, function (err, result) {
            console.log('Raju -< ' + JSON.stringify(result));
...
module.exports = getUnitsByProperty;
//# sourceMappingURL=getUnitsByProperty-controller.js.map